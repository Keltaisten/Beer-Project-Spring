...
#     ADD CONSTRAINT fk_beeweb_on_beer FOREIGN KEY (beer_id) REFERENCES beers (id);
#
# ALTER TABLE beers_webshops
#     ADD CONSTRAINT fk_beeweb_on_webshop FOREIGN KEY (webshops_id) REFERENCES webshops (id);
#
# ALTER TABLE webshops_beers
#     ADD CONSTRAINT fk_webbee_on_beer FOREIGN KEY (beers_id) REFERENCES beers (id);
#
# ALTER TABLE webshops_beers
#     ADD CONSTRAINT fk_webbee_on_webshop FOREIGN KEY (webshop_id) REFERENCES webshops (id);