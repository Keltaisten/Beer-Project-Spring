...
#
# ALTER TABLE webshop_beers
#     ADD CONSTRAINT fk_webbee_on_beer FOREIGN KEY (beer_id) REFERENCES beers (id);
#
# ALTER TABLE webshop_beers
#     ADD CONSTRAINT fk_webbee_on_webshop FOREIGN KEY (webshops_id) REFERENCES webshops (id);